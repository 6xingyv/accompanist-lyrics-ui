...
fun KaraokeLyricsView(
    ...
    onPlayerExpansionProgress: ((progress: Float) -> Unit)? = null,
    onPlayerExpansionSettled: ((progress: Float) -> Unit)? = null,
    ...
    NativeLyricsViewHost(
        ...
        playerExpansionTarget = playerExpansionTarget,
        playerExpansionGeometry = playerExpansionGeometry,
        onPlayerExpansionDragStart = onPlayerExpansionDragStart,
        onPlayerExpansionProgress = onPlayerExpansionProgress,
        onPlayerExpansionSettled = onPlayerExpansionSettled,
